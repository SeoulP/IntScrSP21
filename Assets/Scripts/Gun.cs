...
public class Gun : MonoBehaviour
{
    ...
    public void Use(GameObject frogBullet)
    {
        Debug.Log("<color=red>Pow!</color>");

        // This works for now, may cause problems if there are multiple guns with different firepoints.
        Transform firePoint = GameObject.Find("Fire Point").transform;
